  ...
  rows: [
    {
      ...
      "Hành động": (
        <SoftBox display="flex" alignItems="center" justifyContent="center" gap={1}>
          <SoftButton variant="text" color="info" onClick={() => window.location.href = "/he-thong-quan-ly-healthmate/danh-sach-cong-thuc/chi-tiet-cong-thuc"}>
...
export default recipeTableData;
